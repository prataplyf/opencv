# This is our second program in this we're going to see and analyse that how openCV will read a video in image form, from our system/file.
# we need to import cv2 library that will use to give permission to read and show images

# import opencv libraries
import cv2

# to read video image in python using opoencv we use cv2.VideoCapture() function, here "VideoCapture()" function use to read image from file path.
# capture video
